...
export class SupabaseService implements OnModuleInit {
  ...
  onModuleInit() {
    ...
    if (!supabaseUrl || !supabaseAnonKey) {
      console.warn(
        '⚠️  Supabase credentials not found. Please update your .env file with valid Supabase credentials.',
      );
      console.warn(
        '   The application will start but Supabase features will not work.',
      );
      return;
    }
